...
$query = "SELECT DISTINCT brand, id, name, price, image, motasanpham FROM products WHERE brand = 'trangtri'" . ($category ? " AND category = '$category'" : ""); // Thêm motasanpham vào truy vấn
