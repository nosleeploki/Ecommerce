...
$query = "SELECT DISTINCT brand, id, name, price, image, motasanpham FROM products WHERE brand = 'dungcu'" . ($category ? " AND category = '$category'" : ""); // Thêm motasanpham vào truy vấn
...
<div class="container" style="margin-top:65px">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Dụng cụ</li>
        </ol>
    </nav>
    <!--breadcrumb end-->
